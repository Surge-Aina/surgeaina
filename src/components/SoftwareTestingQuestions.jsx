...
export default function SoftwareTestingQuestions({ onContinue }) {
  ...
  const questions = serviceQuestions['Software Testing'];
  ...
  const canProceedFromStep1 = () => {
    return answers.operating_system && answers.operating_system.length > 0;  
  };

  const canProceedFromStep2 = () => {
    const hasProgrammingLanguagesAnswer = answers.programming_languages && answers.programming_languages.length > 0;  
    const hasLinesOfCodeAnswer = answers.lines_of_code && answers.lines_of_code !== '';
    return hasProgrammingLanguagesAnswer && hasLinesOfCodeAnswer;
  };
  ...
  if (!questions || !Array.isArray(questions)) {
    return (
      <div className="text-center py-8">
        <p className="text-red-600">Error loading questions for Software Testing</p>
      </div>
    );
  }
  ...
  // Step 1: Show only first question (operating_system)
    ...
    return (
      <div className="space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-slate-600">
            What operating system needs to be tested?
          </p>
          <div className="text-sm text-gray-500 mt-2">
            Step 1 of 5
          </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {firstQuestion.options.map((option, index) => {
              ...
              const isSelected = (answers.operating_system || []).includes(optionValue);
              ...
              return (
                <label key={index} className="cursor-pointer block">
                  <input
                    ...
                    checked={isSelected}
                    onChange={(e) => {
                      handleCheckboxChange('operating_system', optionValue, e.target.checked);
                    }}
                    className="sr-only"
                  />
        ...
        <div className="border-t border-gray-200 pt-6">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-500 mt-2">
              {canProceedFromStep1() ? 'Ready to continue' : 'Please select at least one operating system above'}
            </p>
          </div>
        </div>
      </div>
  ...
  // Step 2: Show questions 2 and 3 (programming_languages and lines_of_code)
        ...
        <div className="flex items-center justify-between border-b border-gray-200 pb-4">
          ...
          <div className="text-center flex-1">
            ...
            <p className="text-slate-600 text-sm">
              Tell us about your code and programming languages
            </p>
