...
export default function CloudManagementQuestions({ onContinue }) {
  ...
  const questions = serviceQuestions['Cloud Management'];
  ...
  const canProceedFromStep1 = () => {
    return answers.management_type && answers.management_type.length > 0;  
  };

  const canProceedFromStep2 = () => {
    const hasCloudServiceAnswer = answers.cloud_service && answers.cloud_service.length > 0;  
    const hasBusinessSizeAnswer = answers.business_size && answers.business_size !== '';
    return hasCloudServiceAnswer && hasBusinessSizeAnswer;
  };
  ...
  if (!questions || !Array.isArray(questions)) {
    return (
      <div className="text-center py-8">
        <p className="text-red-600">Error loading questions for Cloud Management</p>
      </div>
    );
  }
  ...
  // Step 1: Show only first question (management_type)
    ...
    return (
      <div className="space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-slate-600">
            What type of cloud management do you need?
          </p>
          <div className="text-sm text-gray-500 mt-2">
            Step 1 of 5
          </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {firstQuestion.options.map((option, index) => {
              ...
              const isSelected = (answers.management_type || []).includes(optionValue);
              ...
              return (
                <label key={index} className="cursor-pointer block">
                  <input
                    ...
                    checked={isSelected}
                    onChange={(e) => {
                      handleCheckboxChange('management_type', optionValue, e.target.checked);
                    }}
                    className="sr-only"
                  />
        ...
        <div className="border-t border-gray-200 pt-6">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-500 mt-2">
              {canProceedFromStep1() ? 'Ready to continue' : 'Please select at least one management type above'}
            </p>
          </div>
        </div>
      </div>
  ...
  // Step 2: Show questions 2 and 3 (cloud_service and business_size)
        ...
        <div className="flex items-center justify-between border-b border-gray-200 pb-4">
          ...
          <div className="text-center flex-1">
            ...
            <p className="text-slate-600 text-sm">
              Tell us about your cloud service and business
            </p>
