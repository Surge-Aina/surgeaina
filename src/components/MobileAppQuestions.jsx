...
export default function MobileAppQuestions({ onContinue }) {
  ...
  const questions = serviceQuestions['Mobile Application Development'];
  ...
  const canProceedFromStep1 = () => {
    return answers.platform && answers.platform.length > 0;  
  };
  ...
  const canProceedFromStep2 = () => {
    ...
    return hasDevelopmentStageAnswer && hasProjectScopeAnswer;
  };

  const canProceedFromStep3 = () => {
    const hasTimelineAnswer = answers.timeline && answers.timeline !== '';
    return hasTimelineAnswer;
  };
  ...
  if (!questions || !Array.isArray(questions)) {
    return (
      <div className="text-center py-8">
        <p className="text-red-600">Error loading questions for Mobile Application Development</p>
      </div>
    );
  }
  ...
  // Step 1: Show only first question (platform)
    ...
    return (
      <div className="space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-slate-600">
            What type of mobile application development do you need?
          </p>
          <div className="text-sm text-gray-500 mt-2">
            Step 1 of 5
          </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {firstQuestion.options.map((option, index) => {
              ...
              const isSelected = (answers.platform || []).includes(optionValue);
              ...
              return (
                <label key={index} className="cursor-pointer block">
                  <input
                    ...
                    checked={isSelected}
                    onChange={(e) => {
                      handleCheckboxChange('platform', optionValue, e.target.checked);
                    }}
                    className="sr-only"
                  />
        ...
        <div className="border-t border-gray-200 pt-6">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-500 mt-2">
              {canProceedFromStep1() ? 'Ready to continue' : 'Please select at least one platform above'}
            </p>
          </div>
        </div>
      </div>
  ...
  // Step 2: Show questions 2 and 3 (development_stage and project_scope)
  ...
  // Step 3: Show timeline question
  if (currentQuestionStep === 3) {
    const timelineQuestion = questions[3]; // Get the timeline question directly
      ...
      <div className="space-y-8">
        ...
        <div className="border-t border-gray-200 pt-6">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-500 mt-2">
              {canProceedFromStep3() ? 'Ready to continue' : 'Please select a timeline above'}
            </p>
          </div>
        </div>
      </div>
